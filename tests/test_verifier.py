...
from verifier import verify_sudoku, _verify_section  # pylint: disable=import-error


class TestVerifier(TestCase):
    """Class for testing that the verifier module works as intended."""
    ...
    def test_chunk_verifier_is_correct(self, test_chunk):
        """Test that the chunk verifier returns True."""
    ...
    def test_chunk_verifier_returns_false(self, test_chunk):
        """Test that the chunk verifier returns False."""
    ...
    def test_verifier_is_correct(self, test_puzzle):
        """Test that the puzzle verifier returns True."""
    ...
    def test_fail_if_puzzle_is_invalid(self, test_puzzle):
        """Test that the puzzle verifier returns False on malformed inputs."""
    ...
    def test_fail_if_puzzle_is_incorrect(self, test_puzzle):
        """Test that the puzzle verifier returns False on incorrect solutions."""
        self.assertFalse(verify_sudoku(test_puzzle))
